...
Identical to train_moe.py, with one addition: --gating-csv-dir, so this can
...
src/gating_mechanism/). train_moe.py itself is left untouched.
...
Usage:
    python train_moe_sam.py --gating-csv-dir data/sam-predictions/gating [OPTIONS]
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Point this at data/sam-predictions/gating/ to train on plain "
            "SAM's gated predictions instead."
        ),
    )
    # W&B
